    ...
    <header>
        ...
        <div class="jumbotron jumbotron-fluid">
            ...
            <div class="container">
                ...
                <p class="lead">Sistem untuk membantu mengelola perpustakaan, dalam peminjaman atau penyimpanan buku dengan berbagai detail.</p>
                <hr class="my-4">
                <p>Ada banyak pilihan buku  di perpustakaan ini</p>
